...
CREATE DATABASE IF NOT EXISTS `nexfly_nacos`;
USE `nexfly_nacos`;
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='多租户改造';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `his_config_info` VALUES (0,1,'application-dev.yaml','DEFAULT_GROUP','','# 数据源\nspring:\n  #避免nacos取网卡出错\n  cloud:\n    inetutils:\n      preferred-networks: 192.168.1\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    type: com.zaxxer.hikari.HikariDataSource\n    hikari:\n      minimum-idle: 0\n      maximum-pool-size: 20\n      idle-timeout: 25000\n      auto-commit: true\n      connection-test-query: SELECT 1\n  data:\n    redis:\n      host: 127.0.0.1\n      password: 123456\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n\nspringdoc:\n  api-docs:\n    path: /v3/api-docs/default\n  # 默认是false，需要设置为true\n  default-flat-param-object: true\n      \n#mybatis的相关配置\nmybatis:\n  #mapper配置文件\n  mapper-locations: classpath:mapper/*Mapper.xml\n  type-aliases-package: com.nexfly.**.model\n  #开启驼峰命名\n  configuration:\n    map-underscore-to-camel-case: true\n\noss:\n  minio:\n    endpoint: http://localhost:9000\n    access-key-id: rag_flow\n    access-key-secret: infini_rag_flow\n\n\nlogging:\n  level:\n    root: info\n# 分页合理化，当查询到页码大于最后一页的时候，返回最后一页的数据，防止vue在最后一页删除时，数据不对的问题\npagehelper:\n  reasonable: true\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: basic\n  inside:\n    key: nexfly-feign-inside-key\n    secret: nexfly-feign-inside-secret\n    # ip白名单，如果有需要的话，用小写逗号分割\n    ips: \n\nnexfly:\n  auth:\n    token:\n      expire:\n        seconds: 18000\n      secret-key: SecretKey012345678901234567890123456789012345678901234567890123456789    \n\nrocketmq:\n  name-server: 127.0.0.1:9876\n\nvector-store:\n  type: weaviate\n  weaviate:\n    host: localhost:8080\n    key: WVF5YThaHlkYwhGUSmCRgsX3tD5ngdN8pkih\n  elasticsearch:\n    host: http://10.1.6.163:1200\n    username: elastic\n    password: infini_rag_flow','6bfca977f98b8722281a0d64c25e3ffd','2024-10-05 09:14:08','2024-10-05 01:14:09','','0:0:0:0:0:0:0:1','I','',''),(0,2,'nexfly-system-dev.yaml','DEFAULT_GROUP','','spring:\n  profiles:\n    active: dev\n  servlet:\n    multipart:\n      max-file-size: 100MB\n      max-request-size: 100MB\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://localhost:3306/nexfly?autoReconnect=true&useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n    username: root\n    password: 123456\n\n','e886be0b63dce4af9cbbe8fcf71548f1','2024-10-05 09:14:08','2024-10-05 01:14:09','','0:0:0:0:0:0:0:1','I','',''),(0,3,'nexfly-auth-dev.yaml','DEFAULT_GROUP','','spring:\n  profiles:\n    active: dev\n  servlet:\n    multipart:\n      max-file-size: 100MB\n      max-request-size: 100MB\n\n  \n','7481003934ed7f76e9c24cdd80b4a3ba','2024-10-05 09:14:08','2024-10-05 01:14:09','','0:0:0:0:0:0:0:1','I','',''),(0,4,'nexfly-gateway-dev.yaml','DEFAULT_GROUP','','spring:\n  codec:\n    max-in-memory-size: 2MB\n  cloud:\n    gateway:\n      globalcors:\n        cors-configurations:\n          \'[/**]\':\n            allow-credentials: true\n            allowed-headers: \"*\"\n            # 半个月内都允许\n            max-age: 1296000\n            # 测试环境，全部允许\n            allowedOriginPatterns: \"*\"\n            # allowedOrigins:\n              # - \"http://localhost:9527\"\n              # - \"http://localhost:9527\"\n              # - \"http://localhost:9528\"\n              # - \"http://localhost:9529\"\n              # - \"http://:9527\"\n            allowedMethods:\n              - GET\n              - POST\n              - PUT\n              - OPTIONS\n              - DELETE\n      discovery:\n        locator:\n          # 开启服务注册和发现\n          enabled: true\n          # 不手动写路由的话，swagger整合不了...\n      routes:\n        - id: nexfly-auth\n          uri: lb://nexfly-auth\n          predicates:\n            - Path=/nexfly-auth/**\n          filters:\n            - RewritePath=/nexfly-auth(?<segment>/?.*), $\\{segment}\n        - id: nexfly-system\n          uri: lb://nexfly-system\n          predicates:\n            - Path=/nexfly-system/**\n          filters:\n            - RewritePath=/nexfly-system(?<segment>/?.*), $\\{segment}\nknife4j:\n  gateway:\n    enabled: true\n    strategy: discover\n    discover:\n      version: openapi3\n      enabled: true\n  \n','019d8787084c6a3fa2576bd67d13a657','2024-10-05 09:14:08','2024-10-05 01:14:09','','0:0:0:0:0:0:0:1','I','',''),(1,5,'application-dev.yaml','DEFAULT_GROUP','','# 数据源\nspring:\n  #避免nacos取网卡出错\n  cloud:\n    inetutils:\n      preferred-networks: 192.168.1\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    type: com.zaxxer.hikari.HikariDataSource\n    hikari:\n      minimum-idle: 0\n      maximum-pool-size: 20\n      idle-timeout: 25000\n      auto-commit: true\n      connection-test-query: SELECT 1\n  data:\n    redis:\n      host: 127.0.0.1\n      password: 123456\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n\nspringdoc:\n  api-docs:\n    path: /v3/api-docs/default\n  # 默认是false，需要设置为true\n  default-flat-param-object: true\n      \n#mybatis的相关配置\nmybatis:\n  #mapper配置文件\n  mapper-locations: classpath:mapper/*Mapper.xml\n  type-aliases-package: com.nexfly.**.model\n  #开启驼峰命名\n  configuration:\n    map-underscore-to-camel-case: true\n\noss:\n  minio:\n    endpoint: http://localhost:9000\n    access-key-id: rag_flow\n    access-key-secret: infini_rag_flow\n\n\nlogging:\n  level:\n    root: info\n# 分页合理化，当查询到页码大于最后一页的时候，返回最后一页的数据，防止vue在最后一页删除时，数据不对的问题\npagehelper:\n  reasonable: true\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: basic\n  inside:\n    key: nexfly-feign-inside-key\n    secret: nexfly-feign-inside-secret\n    # ip白名单，如果有需要的话，用小写逗号分割\n    ips: \n\nnexfly:\n  auth:\n    token:\n      expire:\n        seconds: 18000\n      secret-key: SecretKey012345678901234567890123456789012345678901234567890123456789    \n\nrocketmq:\n  name-server: 127.0.0.1:9876\n\nvector-store:\n  type: weaviate\n  weaviate:\n    host: localhost:8080\n    key: WVF5YThaHlkYwhGUSmCRgsX3tD5ngdN8pkih\n  elasticsearch:\n    host: http://10.1.6.163:1200\n    username: elastic\n    password: infini_rag_flow','6bfca977f98b8722281a0d64c25e3ffd','2024-10-09 11:45:41','2024-10-09 11:45:42','nacos','172.20.0.1','U','',''),(2,6,'nexfly-system-dev.yaml','DEFAULT_GROUP','','spring:\n  profiles:\n    active: dev\n  servlet:\n    multipart:\n      max-file-size: 100MB\n      max-request-size: 100MB\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://localhost:3306/nexfly?autoReconnect=true&useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n    username: root\n    password: 123456\n\n','e886be0b63dce4af9cbbe8fcf71548f1','2024-10-09 11:46:26','2024-10-09 11:46:27','nacos','172.20.0.1','U','',''),(2,7,'nexfly-system-dev.yaml','DEFAULT_GROUP','','spring:\n  profiles:\n    active: dev\n  servlet:\n    multipart:\n      max-file-size: 100MB\n      max-request-size: 100MB\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://nexfly-mysql:3306/nexfly?autoReconnect=true&useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n    username: root\n    password: nexfly9527\n\n','729d1ef5b15215fc7eb196cec93d3b64','2024-10-12 09:36:48','2024-10-12 09:36:48','nacos','172.20.0.1','U','',''),(1,8,'application-dev.yaml','DEFAULT_GROUP','','# 数据源\nspring:\n  #避免nacos取网卡出错\n  cloud:\n    inetutils:\n      preferred-networks: 192.168.1\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    type: com.zaxxer.hikari.HikariDataSource\n    hikari:\n      minimum-idle: 0\n      maximum-pool-size: 20\n      idle-timeout: 25000\n      auto-commit: true\n      connection-test-query: SELECT 1\n  data:\n    redis:\n      host: nexfly-redis\n      password: nexfly9527\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n\nspringdoc:\n  api-docs:\n    path: /v3/api-docs/default\n  # 默认是false，需要设置为true\n  default-flat-param-object: true\n      \n#mybatis的相关配置\nmybatis:\n  #mapper配置文件\n  mapper-locations: classpath:mapper/*Mapper.xml\n  type-aliases-package: com.nexfly.**.model\n  #开启驼峰命名\n  configuration:\n    map-underscore-to-camel-case: true\n\noss:\n  minio:\n    endpoint: http://nexfly-minio:9000\n    access-key-id: nexfly\n    access-key-secret: nexfly9527\n\n\nlogging:\n  level:\n    root: info\n# 分页合理化，当查询到页码大于最后一页的时候，返回最后一页的数据，防止vue在最后一页删除时，数据不对的问题\npagehelper:\n  reasonable: true\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: basic\n  inside:\n    key: nexfly-feign-inside-key\n    secret: nexfly-feign-inside-secret\n    # ip白名单，如果有需要的话，用小写逗号分割\n    ips: \n\nnexfly:\n  auth:\n    token:\n      expire:\n        seconds: 18000\n      secret-key: SecretKey012345678901234567890123456789012345678901234567890123456789    \n\nrocketmq:\n  name-server: nexfly-rocketmq-namesrv:9876\n\nvector-store:\n  type: elasticsearch\n  elasticsearch:\n    host: http://nexfly-elasticsearch:1200\n    username: elastic\n    password: nexfly9527\n  weaviate:\n    host: localhost:8080\n    key: WVF5YThaHlkYwhGUSmCRgsX3tD5ngdN8pkih','24b7777dd07fe5ef9780f343ae95b35d','2024-10-12 10:30:21','2024-10-12 10:30:21','nacos','172.20.0.1','U','',''),(1,9,'application-dev.yaml','DEFAULT_GROUP','','# 数据源\nspring:\n  #避免nacos取网卡出错\n  cloud:\n    inetutils:\n      preferred-networks: 192.168.1\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    type: com.zaxxer.hikari.HikariDataSource\n    hikari:\n      minimum-idle: 0\n      maximum-pool-size: 20\n      idle-timeout: 25000\n      auto-commit: true\n      connection-test-query: SELECT 1\n  data:\n    redis:\n      host: nexfly-redis\n      password: nexfly9527\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n\nspringdoc:\n  api-docs:\n    path: /v3/api-docs/default\n  # 默认是false，需要设置为true\n  default-flat-param-object: true\n      \n#mybatis的相关配置\nmybatis:\n  #mapper配置文件\n  mapper-locations: classpath:mapper/*Mapper.xml\n  type-aliases-package: com.nexfly.**.model\n  #开启驼峰命名\n  configuration:\n    map-underscore-to-camel-case: true\n\noss:\n  minio:\n    endpoint: http://nexfly-minio:9000\n    access-key-id: nexfly\n    access-key-secret: nexfly9527\n\n\nlogging:\n  level:\n    root: info\n# 分页合理化，当查询到页码大于最后一页的时候，返回最后一页的数据，防止vue在最后一页删除时，数据不对的问题\npagehelper:\n  reasonable: true\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: basic\n  inside:\n    key: nexfly-feign-inside-key\n    secret: nexfly-feign-inside-secret\n    # ip白名单，如果有需要的话，用小写逗号分割\n    ips: \n\nnexfly:\n  auth:\n    token:\n      expire:\n        seconds: 18000\n      secret-key: SecretKey012345678901234567890123456789012345678901234567890123456789    \n\nrocketmq:\n  name-server: nexfly-rocketmq-namesrv:9876\n\nvector-store:\n  type: elasticsearch\n  elasticsearch:\n    host: http://nexfly-elasticsearch:9200\n    username: elastic\n    password: nexfly9527\n  weaviate:\n    host: localhost:8080\n    key: WVF5YThaHlkYwhGUSmCRgsX3tD5ngdN8pkih','c3f990690e53ef2ec494ff38c4a961f8','2024-10-26 11:27:22','2024-10-26 11:27:22','nacos','172.20.0.1','U','',''),(1,10,'application-dev.yaml','DEFAULT_GROUP','','# 数据源\nspring:\n  #避免nacos取网卡出错\n  cloud:\n    inetutils:\n      preferred-networks: 192.168.1\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    type: com.zaxxer.hikari.HikariDataSource\n    hikari:\n      minimum-idle: 0\n      maximum-pool-size: 20\n      idle-timeout: 25000\n      auto-commit: true\n      connection-test-query: SELECT 1\n  data:\n    redis:\n      host: nexfly-redis\n      password: nexfly9527\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n\nspringdoc:\n  api-docs:\n    path: /v3/api-docs/default\n  # 默认是false，需要设置为true\n  default-flat-param-object: true\n      \n#mybatis的相关配置\nmybatis:\n  #mapper配置文件\n  mapper-locations: classpath:mapper/*Mapper.xml\n  type-aliases-package: com.nexfly.**.model\n  #开启驼峰命名\n  configuration:\n    map-underscore-to-camel-case: true\n\noss:\n  minio:\n    endpoint: http://nexfly-minio:9000\n    access-key-id: nexfly\n    access-key-secret: nexfly9527\n\n\nlogging:\n  level:\n    root: debug\n# 分页合理化，当查询到页码大于最后一页的时候，返回最后一页的数据，防止vue在最后一页删除时，数据不对的问题\npagehelper:\n  reasonable: true\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: basic\n  inside:\n    key: nexfly-feign-inside-key\n    secret: nexfly-feign-inside-secret\n    # ip白名单，如果有需要的话，用小写逗号分割\n    ips: \n\nnexfly:\n  auth:\n    token:\n      expire:\n        seconds: 18000\n      secret-key: SecretKey012345678901234567890123456789012345678901234567890123456789    \n\nrocketmq:\n  name-server: nexfly-rocketmq-namesrv:9876\n\nvector-store:\n  type: elasticsearch\n  elasticsearch:\n    host: http://nexfly-elasticsearch:9200\n    username: elastic\n    password: nexfly9527\n  weaviate:\n    host: localhost:8080\n    key: WVF5YThaHlkYwhGUSmCRgsX3tD5ngdN8pkih','f9c7ee2e0d61a5b51bd1c654b655a57c','2024-10-26 11:28:31','2024-10-26 11:28:32','nacos','172.20.0.1','U','',''),(1,11,'application-dev.yaml','DEFAULT_GROUP','','# 数据源\nspring:\n  #避免nacos取网卡出错\n  cloud:\n    inetutils:\n      preferred-networks: 192.168.1\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    type: com.zaxxer.hikari.HikariDataSource\n    hikari:\n      minimum-idle: 0\n      maximum-pool-size: 20\n      idle-timeout: 25000\n      auto-commit: true\n      connection-test-query: SELECT 1\n  data:\n    redis:\n      host: nexfly-redis\n      password: nexfly9527\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n\nspringdoc:\n  api-docs:\n    path: /v3/api-docs/default\n  # 默认是false，需要设置为true\n  default-flat-param-object: true\n      \n#mybatis的相关配置\nmybatis:\n  #mapper配置文件\n  mapper-locations: classpath:mapper/*Mapper.xml\n  type-aliases-package: com.nexfly.**.model\n  #开启驼峰命名\n  configuration:\n    map-underscore-to-camel-case: true\n\noss:\n  minio:\n    endpoint: http://nexfly-minio:9000\n    access-key-id: nexfly\n    access-key-secret: nexfly9527\n\n\nlogging:\n  level:\n    root: info\n# 分页合理化，当查询到页码大于最后一页的时候，返回最后一页的数据，防止vue在最后一页删除时，数据不对的问题\npagehelper:\n  reasonable: true\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: basic\n  inside:\n    key: nexfly-feign-inside-key\n    secret: nexfly-feign-inside-secret\n    # ip白名单，如果有需要的话，用小写逗号分割\n    ips: \n\nnexfly:\n  auth:\n    token:\n      expire:\n        seconds: 18000\n      secret-key: SecretKey012345678901234567890123456789012345678901234567890123456789    \n\nrocketmq:\n  name-server: nexfly-rocketmq-namesrv:9876\n\nvector-store:\n  type: elasticsearch\n  elasticsearch:\n    host: http://nexfly-elasticsearch:9200\n    username: elastic\n    password: nexfly9527\n  weaviate:\n    host: localhost:8080\n    key: WVF5YThaHlkYwhGUSmCRgsX3tD5ngdN8pkih','c3f990690e53ef2ec494ff38c4a961f8','2024-10-26 11:31:39','2024-10-26 11:31:40','nacos','172.20.0.1','U','',''),(2,12,'nexfly-system-dev.yaml','DEFAULT_GROUP','','spring:\n  profiles:\n    active: dev\n  servlet:\n    multipart:\n      max-file-size: 100MB\n      max-request-size: 100MB\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://nexfly-mysql:3308/nexfly?autoReconnect=true&useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai\n    username: root\n    password: nexfly9527\n\n','14a9c592a97d462be726ab1488a5dca7','2024-10-28 18:00:16','2024-10-28 18:00:16','nacos','172.20.0.1','U','','');
...
-- Dump completed on 2024-10-28 18:01:14
