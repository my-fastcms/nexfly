...
public class TongYiImageOptions implements ImageOptions {
	...
	public static class Builder {
		...
		private final TongYiImageOptions options;

		private Builder() {
			this.options = new TongYiImageOptions();
		}
		...
		public TongYiImageOptions build() {
			return options;
		}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof TongYiImageOptions that))
			return false;
	...
	public String toString() {
		return "TongYiImageOptions{" + "n=" + n + ", model='" + model + '\'' + ", width=" + width + ", height=" + height
