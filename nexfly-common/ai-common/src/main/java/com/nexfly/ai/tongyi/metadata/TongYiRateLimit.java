...
public class TongYiRateLimit implements RateLimit {
	...
	public TongYiRateLimit(Long requestsLimit, Long requestsRemaining, Duration requestsReset, Long tokensLimit,
